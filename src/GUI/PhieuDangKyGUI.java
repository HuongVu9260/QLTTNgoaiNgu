    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            if (txtcmnd.getText().equals("Nhập cmnd") || txtemail.getText().equals("Nhập email") || txttts.getText().equals("Nhập tên thí sinh") || txtnoisinh.getText().equals("Nhập nơi sinh") || txtsdt.getText().equals("Nhập sđt")) {
                ...
                if (txtcmnd.getText().matches(pattern) == false && txtcmnd.getText().matches(pattern0) == false) {
                    JOptionPane.showMessageDialog(null, "CMND bắc buộc phải 10 số hoặc 12 số", "Thông báo", 0);
                } else {
                    thisinh.setCmnd(txtcmnd.getText());
                    String pattern1 = "^[a-zA-Z][\\w-]+@([\\w]+\\.[\\w]+|[\\w]+\\.[\\w]{2,}\\.[\\w]{2,})$";
                    if (txtemail.getText().matches(pattern1) == false) {
                        ...
                        if (cb.getSelectedIndex() == 0 || cb2.getSelectedIndex() == 0) {
                            ...
                            if (txtsdt.getText().matches(pattern2) == false) {
