...
public class test {
    ...
    private String t="";
    public test(String host, String user, String pw, String database){
        this.host = host;
        this.user = user;
        this.pw = pw;
    ...
    public static void main(String[] args) throws Exception {
        test data = new test("localhost", "root", "", "ngoaingu");
        ResultSet rs = data.executeQuery("select * from cathi");
        while(rs.next())
        {
